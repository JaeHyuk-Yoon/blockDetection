...
def run(
    ...
    # playsound.playsound('/home/jet/Desktop/yolov5/tts/start.mp3')
    #이전 시간
    prevTime = time.time()
    num_iterations = 1
            ...
            if len(det):
                ...
                if  ( typeCountDic['Crosswalk'] >= 5 or typeCountDic['Bollard'] >= 5 or typeCountDic['Dotted'] >= 5 
                    ...
                    if typeCountDic['Crosswalk'] >= 5 and typeCountDic['Bollard'] >= 5:
                        print(".")
                        # playsound.playsound('/home/jet/Desktop/yolov5/tts/bollardAndCross.mp3')
                    elif typeCountDic['Bollard'] >= 5:
                        print(".")
                        # playsound.playsound('/home/jet/Desktop/yolov5/tts/bollard.mp3')
                    elif typeCountDic['Crosswalk'] >= 5:
                        print(".")
                        # playsound.playsound('/home/jet/Desktop/yolov5/tts/crosswalk.mp3')

                    if typeCountDic['Plus'] >= 5:
                        print(".")
                        # playsound.playsound('/home/jet/Desktop/yolov5/tts/plus.mp3')
                    elif typeCountDic['T'] >= 5:
                        print(".")
                        # playsound.playsound('/home/jet/Desktop/yolov5/tts/T.mp3')
                    elif typeCountDic['rNg'] >= 5:
                        print(".")
                        # playsound.playsound('/home/jet/Desktop/yolov5/tts/turnYourRight.mp3')
                        # playsound.playsound('/home/jet/Desktop/yolov5/tts/goStraight.mp3')
                    elif typeCountDic['lNg'] >= 5:
                        print(".")
                        # playsound.playsound('/home/jet/Desktop/yolov5/tts/turnYourLeft.mp3')
                        # playsound.playsound('/home/jet/Desktop/yolov5/tts/goStraight.mp3')
                        ...
                        print(".")
                        # playsound.playsound('/home/jet/Desktop/yolov5/tts/dotted.mp3')
